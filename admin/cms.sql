...
post_id`,
`post_category_id
`, `post_title`, `post_author`, `post_date`, `post_image`, `post_tags`, `post_comment_count`, `post_status`, `post_content`) VALUES
...
user_id`,
`user_name
`, `user_password`, `user_firstname`, `user_lastname`, `user_email`, `user_image`, `user_role`, `rand_salt`) VALUES
...
ALTER TABLE `categories`
  MODIFY `cat_id` int
(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
